...
const HeroCarousel_Responsive = () => {
  ...
  useEffect(() => {
    ...
    const updateCurve = (
      ...
      if (isMobile) {
        // 🔥 MÓVIL: centro fuerte + extremos suaves
        ...
        // 💻 DESKTOP: estilo anterior, lateral
        ...
        for (let i = 0; i < positionAttr.count; i++) {
          ...
          const vertexWorldPos = worldPosition + x; // horizontal
...
export default HeroCarousel_Responsive;